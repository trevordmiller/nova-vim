...
const sourceString = `
  ...
  let s:p.normal.right    = [ [ s:white, s:active_bg ], [ s:white, s:active_bg ] ]
  let s:p.normal.middle   = [ [ s:white, s:active_bg ] ]

  let s:p.insert.left     = [ [ s:black, s:insert_color, 'bold' ], [ s:white, s:active_bg ] ]
  let s:p.insert.right    = [ [ s:white, s:active_bg ], [ s:white, s:active_bg ] ]
  let s:p.insert.middle   = [ [ s:white, s:active_bg ] ]

  let s:p.replace.left    = [ [ s:black, s:replace_color, 'bold' ], [ s:white, s:active_bg ] ]
  let s:p.replace.right   = [ [ s:white, s:active_bg ], [ s:white, s:active_bg ] ]
  let s:p.replace.middle  = [ [ s:white, s:active_bg ] ]

  let s:p.visual.left     = [ [ s:black, s:visual_color, 'bold' ], [ s:white, s:active_bg ] ]
  let s:p.visual.right    = [ [ s:white, s:active_bg ], [ s:white, s:active_bg ] ]
  let s:p.visual.middle   = [ [ s:white, s:active_bg ] ]

  let s:p.inactive.left   = [ [ s:white, s:active_bg, 'bold' ], [ s:white, s:active_bg ] ]
  let s:p.inactive.right  = [ [ s:white, s:active_bg ], [ s:white, s:active_bg ] ]
  let s:p.inactive.middle = [ [ s:white, s:active_bg ] ]
